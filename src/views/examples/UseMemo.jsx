...
const UseMemo = (props) => {
    ...
    //alternativa: useState + useEffect
   ...
   //a função soma só sera invocada se os valores n1 e n2 mudarem
   //gera um valor em cash, memorizável, caso as dependências sejam modificadas
